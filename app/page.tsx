  ...
  return (
    <main>
      <header className="nav">
        <a href="#top" className="brand"><span className="brandMark">A</span><span>ALTIVIO<small>Digital Studio</small></span></a>
        <nav>
          <a href="#services">{t.nav[0]}</a><a href="#work">{t.nav[1]}</a><a href="#process">{t.nav[2]}</a><a href="#pricing">{t.nav[3]}</a><a href="#contact">{t.nav[4]}</a>
        </nav>
